...
<body>
	<div class="card mx-auto w-95 border-secondary" style="margin-top: 40px;">
		<h5 class="card-header h5 bg-secondary text-white">Edit Donator Coins</h5>
		<div class="card-body my-auto text-center">

			<div class="card mx-auto w-95" style="margin-top: 40px;">
				<h5 class="card-header h5 bg-secondary text-light">Send Donator
					Coins</h5>
				<div class="card-body my-auto text-center">
			...
			<div class="card mx-auto w-95" style="margin-top: 40px;">
				...
				<div class="card-body my-auto text-center">
					<div class="container w-50">
						<label class="sr-only" for="inlineFormInputGroupUsername2">Donator
							Coins</label>
						<div class="input-group mb-2 mr-sm-2">
							<div class="input-group-prepend">
								<div class="input-group-text">
							...
							<input type="text" class="form-control"
								id="inlineFormInputGroupUsername2" placeholder="Donator Coins">
						</div>
